...
import 'package:q_trip_user/data/model/base/api_response.dart';
...
class AuthRepositoryImp implements AuthRepository{
  ...
  Future<ApiResponse> register({required RegisterBody registerBody})  async {
    try {
      Response response = await _dioClient.post(AppURL.kRegisterURI, queryParameters: registerBody.toJson(),filePath: registerBody.image);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> otpCode({required CheckOTPBody checkOTPBody})  async {
    try {
      Response response = await _dioClient.post(AppURL.kCheckOTPURI, queryParameters: checkOTPBody.toJson(),);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> changePassword({required String password})   async {
    try {
      Response response = await _dioClient.post(AppURL.kChangePasswordURI, queryParameters: {'password':password},);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> updateFCMToken({required String fcmToken,required String deviceType}) async {
    try {
      Response response = await _dioClient.post(AppURL.kUpdateFCMTokenURI,queryParameters: {'fcm_token':fcmToken,'type':deviceType});
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> sendOtp({required String phone})async {
    try {
      Response response = await _dioClient.post(AppURL.kSendOtpURI,queryParameters: {'mobile_number':phone});
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
