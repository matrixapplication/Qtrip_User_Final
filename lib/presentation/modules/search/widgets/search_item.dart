...
class SearchItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        var searchCubit = BlocProvider.of<SearchCubit>(context,listen: false);
        searchCubit.updateLocation(_addressBody);
        // bool isAddressSelectedSuccessfully = searchCubit.isAddressSelectedSuccessfully;
        // if(isAddressSelectedSuccessfully){
        //   NavigationService.push(RoutesDriver.driverSelectCarScreen,arguments: {'from':searchCubit.fromAddressBody,'to':searchCubit.toAddressBody});
        // }
      },
      child: Column(
        children: [
